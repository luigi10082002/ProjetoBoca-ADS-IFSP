...
int main() {
    ...
    for (i = 0; resultadosEntradas[i] != NULL; i++) {
        ...
        printf("==================================================\n");
        free(resultadosEntradas[i]); // Libera a memÃ³ria alocada para cada conteÃºdo
    }
    ...
    for (i = 0; resultadosSaidasEsperadasArquivos[i] != NULL; i++) {
        ...
        printf("==================================================\n");
        free(resultadosSaidasEsperadasArquivos[i]); // Libera a memÃ³ria alocada para cada conteÃºdo
    }
